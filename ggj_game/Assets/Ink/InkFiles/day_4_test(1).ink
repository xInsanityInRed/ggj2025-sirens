...
VAR essence_fisherman = false
VAR essence_elder = false
VAR essence_child = false
...
VAR song_hope = false
VAR song_anger = false
VAR song_disgust = false
VAR song_boredom = false
VAR song_surprise = false
VAR song_shame = false

// Which trinkets has the siren received?
VAR trinket_day_three = false
VAR trinket_day_four = false
VAR trinket_day_five = false
VAR trinket_day_six = false
...
Come into the water. <i>Come into the water. <b>Come into the water.</b></i># narration
* [Continue staring]
->loremaster_beauty
